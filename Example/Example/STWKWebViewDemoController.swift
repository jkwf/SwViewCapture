...
class STWKWebViewDemoController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.rightBarButtonItem = UIBarButtonItem(title: "Capture", style: .plain, target: self, action: #selector(STWKWebViewDemoController.didCaptureBtnClicked(_:)))
