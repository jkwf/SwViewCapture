...
class STScrollViewDemoController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.rightBarButtonItem = UIBarButtonItem(title: "Capture", style: .plain, target: self, action: #selector(STScrollViewDemoController.didCaptureBtnClicked(_:)))
